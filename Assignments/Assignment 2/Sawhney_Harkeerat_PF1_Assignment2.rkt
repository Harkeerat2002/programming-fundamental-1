...
;;(check-expect (quarter-->angle 1) "0 degrees")                     commented so that it doesnt get mixed with the last excercise
...
(define (quarter-->angle quarter_hours)
  (cond
    [(equal? quarter_hours 0) (rotate 90 Rectangle)]
    [(equal? quarter_hours 1) (rotate 0 Rectangle)]
    [(equal? quarter_hours 2) (rotate 270 Rectangle)]
    [(equal? quarter_hours 3) (rotate 180 Rectangle)]))
;---------------------------------------------------------------------------------------------
(require 2htdp/image)

; Data type for Quarter Hours --> Integer
; Data type for Degrees       --> string
; Data type for Minutes       --> Number
; Data type for clock         --> Image
...
; Method 2
;(quarter-->angle 0) should be 90 degrees
(check-expect (quarter-->angle 0) (rotate 90 Rectangle))
;(quarter-->angle 1) should be 0 degrres
(check-expect (quarter-->angle 1) (rotate 0 Rectangle))
;(quarter-->angle 2) should be 0 degrres
(check-expect (quarter-->angle 2) (rotate 270 Rectangle))
;(quarter-->angle 1) should be 0 degrres
(check-expect (quarter-->angle 3) (rotate 180 Rectangle))
...
(define (clock-minutes clock-hour)
 (quarter-->angle clock-hour)) 
